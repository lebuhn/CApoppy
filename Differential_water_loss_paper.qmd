...
Ovary and petal surface temperatures were not significantly lower than ambient temperature.
...
The second graph isolates the first flower which continued to bloom for a second day. Thermocouple 1 is in the ovary, Thermocouple 2 is suspended in the flower. Thermocouple 3 was in open air.
...
AllTemp4 <- ggplot(df4, aes(DateTime, value)) +
           ...
           geom_point(aes(colour=sensor),                # colour depends on variable
               size=1)+
         ggtitle("Figure 2. Flower and ovary temperature on second day of bloom- one flower ovary and bowl-2nd day of bloom") +
         xlab("Date") + ylab("Air Temperature (C)")
