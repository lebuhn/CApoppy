...
This script analyzes the porometer and flower length data from a single point in time (25 march 2025) at Percos.
...
# Load the data
getwd()
data <- read_excel("../data/raw/plant/Flower_traits.xlsx")
