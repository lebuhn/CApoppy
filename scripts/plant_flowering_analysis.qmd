...
The dependent variable is whatever timing variable we're analyzing
The fixed effect is Locality (population)
The random effect is Plant nested within Locality
The (1|Locality:Plant) term allows each plant to have its own random intercept
